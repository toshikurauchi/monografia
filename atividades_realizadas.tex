...
\end{longtable}
\captionof{figure}{As imagens acima foram extraídas da aplicação de visualização de campos tensoriais. Cada imagem mostra o campo tensorial de um cérebro humano sendo descartados alguns tensores de acordo com o valor de anisotropia fracionada.}
\end{center}
