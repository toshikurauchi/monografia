...
O \texttt{RenderVisitor} é a classe abstrata que deve ser implementada por todos os \texttt{visitors} que fazem renderização, ele é importante, pois implementa o conceito de \texttt{frustum culling}
