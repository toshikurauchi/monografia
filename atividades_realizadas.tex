% tem um algorirtimo em algum lugar aqui
...
Com o aumento da quantidade de dados enviados à GPU através de texturas, surge um problema, as texturas padrão das APIs gráficas conseguem indexar apenas um pequeno número de pixels na textura.
...
% Tentar colocar o caption aqui
% Mandar essa imagem pros resultados obtidos
