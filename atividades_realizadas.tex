...
Um \texttt{UniformSet} é uma classe que representa um conjunto de valores de uniforme que foram definidos pelo usuário, cada uniform set é responsável por gerenciar instâncias de \texttt{UniformValue}.
