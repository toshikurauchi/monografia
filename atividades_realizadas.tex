...
O UpdatePassVisitor é responsável por fazer a travessia dentro do UpdatePass do renderizador. Durante a travessia esse visitor executa o método updatePass e em seguida continua a busca em profundidade e, por fim, executa o método postUpdatePass.
