...
\end{longtable}
\end{center}
\hspace{0.25\textwidth}\parbox{0.5\textwidth}{\captionof{figure}{Imagem resultante de uma simulação da formação de uma galáxia de disco~\cite{galaxy}. Essa simulação inclui a visualização da formação estelar e ventos galáticos, o que aumenta a complexidade da cena.}}
