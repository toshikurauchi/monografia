...
Quando a thread principal recebe a mensagem \texttt{WM_QUIT}, o retorno de \texttt{GetMessage} é 0, nesse momento a tradução e envio de mensagens deve parar e o programa deve apagar o registro da classe criada por \texttt{RegisterClass}. O registro é apagado pela função\cite{docunregisterclass}:
