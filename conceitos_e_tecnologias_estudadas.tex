...
Nessa função, o argumento hwnd é o handle da janela corrente, uMsg é um inteiro sem sinal que códifica a mensagem recebida e os argumentos wParam e lParam são os parâmetros da mensagem.
...
Essa função tem como argumento o handle para o dispositivo utilizado pela janela. Tal handle pode ser obtido através da função GetDC \cite{getdcdoc}: %TODO essa citação está como [?]
