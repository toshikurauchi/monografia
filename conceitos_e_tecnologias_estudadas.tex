...
no apêndice~\ref{criacaojanela} e a documentação detalhada sobre a windows API
pode ser encontrada no site da MSDN~\cite{msdn}
...
\end{center}
\vspace{-20pt}
\caption{O conceito de isotropia e anisotropia aplicado em tecidos biológicos.}
\vspace{-10pt}
\end{figure}
