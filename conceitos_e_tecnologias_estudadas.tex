...
O conceito de transformações lineares é de importância fundamental para a computação gráfica. 
Através delas é possível representar de maneira unificada translações, rotações
e escalas aplicadas sobre os objetos.
